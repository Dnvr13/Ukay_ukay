...
import { useInsertCustomerBackend } from "../../../../backend/customer.backend";
...
const AddCustomerComp = ({ setAddCustomer, handleRefresh }) => {
    ...
    const { response, loading, error, insertCustomer } = useInsertCustomerBackend();
    ...
    return (
        <div className="">
            ...
            <h2 className="mt-8 text-xl font-semibold text-gray-700 mb-4">Add User Information</h2>
            <form onSubmit={handleSubmit}>
                <div className="mb-4">
                    <label className="block text-gray-600 mb-1" htmlFor="name">Username</label>
                    <input
                        type="text"
                        id="username"
                        name="username"

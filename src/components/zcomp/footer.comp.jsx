  ...
  return (
    <footer className="bg-white py-6">
      ...
      <div className="text-center text-sm font-light mt-5 pt-3 border-t border-black">
        © 2024 | Gulmatico 2nd Hand Clothing Store | All Rights Reserved | Powered by [Ukay-ukay.vercel].app
      </div>
    </footer>
  );
};
